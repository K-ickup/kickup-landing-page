...
const CASES = [
  ...
  },
  {
    ...
    context: "120 salariés · Grenoble",
    challenge:
      "ERP, CRM et système de caisse non connectés. Les équipes ressaisissaient manuellement les commandes entre trois outils : erreurs fréquentes, délais, perte d'information.",
    solution:
      "Middleware d'intégration reliant ERP (Sage), CRM (HubSpot) et logiciel de caisse en synchronisation bidirectionnelle temps réel. Zéro remplacement des outils existants.",
    result: "−12h/semaine de ressaisie",
    tag: "Intégration systèmes",
  },
];
