      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          >
            <img
              src="/jeremy.png"
              alt="Jérémy Dumas - Fondateur & CTO de Kickup"
              style={{
                width: "min(320px, 100%)",
                aspectRatio: "4/5",
                borderRadius: 16,
          ...
          >
            ...
            >
              ...
              ne peut pas offrir. Avec moi, des experts techniques partageant
              cette exigence et cet engagement.
            </p>
          </motion.div>
        </div>
      </div>
